// src/Pages/ToolRequests/components/ToolRequestCard.jsx
  ...
  <Card elevation={3} sx={{ borderRadius: 2 }}>
    <CardContent>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mt: 1 }}>
        <Typography variant="body1"><b>Priority:</b></Typography>
        <Chip
...
export default ToolRequestCard;
