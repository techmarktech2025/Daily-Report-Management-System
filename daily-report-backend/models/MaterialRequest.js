...
const MaterialRequest = sequelize.define('MaterialRequest', {
  ...
  status: {
    type: DataTypes.ENUM('Pending', 'Approved', 'Rejected', 'Partially Approved', 'Delivered', 'Cancelled'),
  ...
  delivery_status: {
    type: DataTypes.ENUM('Not Delivered', 'Partially Delivered', 'Fully Delivered'),
  ...
  hooks: {
    beforeCreate: (request) => {
      if (!request.request_id) {
        ...
        request.request_id = `MAT-${timestamp}${random}`;
      }
    }
  },
  indexes: [
